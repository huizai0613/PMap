...
public class ImgButtonVertical extends ImgBaseButton {
	...
	public ImgButtonVertical(Context context, AttributeSet attrs) {
		super(context, attrs);
		// TODO Auto-generated constructor stub

		LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		inflater.inflate(R.layout.button_img_vertical, this);
		...
		relativeLayout2.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				if (icallBack != null) {
					icallBack.onClick(ImgButtonVertical.this);
				}
			}
		});
	}
