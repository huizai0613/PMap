	...
	public View getGroupView(int groupPosition, boolean isExpanded,
		...
		if (convertView == null) {
			convertView = (RelativeLayout) RelativeLayout.inflate(
					mContext, R.layout.offlinemap_gd_group, null);
		}
		...
		if (isOpen[groupPosition]) {
			group_image.setBackground(VectorDrawable.getDrawable(mContext, R.drawable.iconfont_listitem_arrowdown));
		} else {
			group_image.setBackground(VectorDrawable.getDrawable(mContext,R.drawable.iconfont_listitem_arrowright));
		}
		return convertView;
	}
