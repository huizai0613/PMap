package xxzx.offlineMap.offlineMapGd;
...
//				break;
	...
	private void initView() {
		...
		mOffLineChildView = inflater.inflate(R.layout.offlinemap_gd_map_child, null);
	...
	private void displayDefault() {
		...
		mDownloadImage.setBackground(VectorDrawable.getDrawable(mContext, R.drawable.iconfont_download));
		//mDownloadImage.setImageResource(R.mipmap.offlinearrow_download);
	}
	...
	private void displayWaitingStatus(int completeCode) {
		mDownloadProgress.setVisibility(View.VISIBLE);
		mDownloadImage.setVisibility(View.VISIBLE);
		mDownloadImage.setBackground(VectorDrawable.getDrawable(mContext, R.drawable.iconfont_start));
	...
	private void displyaLoadingStatus(int completeCode) {
		...
		mDownloadImage.setVisibility(View.VISIBLE);
		mDownloadImage.setBackground(VectorDrawable.getDrawable(mContext, R.drawable.iconfont_stop));
