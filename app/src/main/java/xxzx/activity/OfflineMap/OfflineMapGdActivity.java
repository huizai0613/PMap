...
import xxzx.offlineMap.offlineMapGd.OfflineDownloadedAdapter;
import xxzx.offlineMap.offlineMapGd.OfflineListAdapter;
import xxzx.offlineMap.offlineMapGd.OfflinePagerAdapter;
import xxzx.offlineMap.offlineMapGd.ToastUtil;
import xxzx.publicClass.MySingleClass;

/**
 * AMapV2地图中简单介绍离线地图下载
 */
public class OfflineMapGdActivity extends Activity implements
	...
	private Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case UPDATE_LIST:
				...
				break;
			case SHOW_MSG:
				ToastUtil.showShortToast(OfflineMapGdActivity.this, (String) msg.obj);
				break;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_offline_map_gd);
...
//		initDialog();
	...
	private void init() {
		...
		mapView= MySingleClass.getInstance().getBaseMapViewClass().getMapView();
	...
	public void initAllCityList() {
		// 扩展列表
		View provinceContainer = LayoutInflater.from(OfflineMapGdActivity.this)
				.inflate(R.layout.offlinemap_gd_province_listview, null);
	...
	public void initDownloadedList() {
		mDownLoadedList = (ListView) LayoutInflater.from(
				OfflineMapGdActivity.this).inflate(
				R.layout.offlinemap_gd_downloaded_list, null);
	...
	public void onDownload(int status, int completeCode, String downName) {
		...
		case OfflineMapStatus.EXCEPTION_NETWORK_LOADING:
			Log.e("amap-download", "download: " + " EXCEPTION_NETWORK_LOADING "
					+ downName);
			Toast.makeText(OfflineMapGdActivity.this, "网络异常", Toast.LENGTH_SHORT)
					.show();
			amapManager.pause();
			break;
