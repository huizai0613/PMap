...
import xxzx.activity.PoiAndRoute.PoiSearchActivity;
...
public class MapStateSelectPoi extends BaseMainMapState implements ActionMenuView.OnMenuItemClickListener{
    ...
    // 构造函数
    public MapStateSelectPoi(Context context, AppCompatDelegate delegate, AppBarLayout appBarLayout, LinearLayout bottomContainer, Object _mData) {
    ...
    protected void BackKeyDown() {
        ...
        intent.setClass(mContext, PoiSearchActivity.class);
    ...
    private LatLng getPoint(){
        ...
        Projection proj = mapView.getMap().getProjection(); // 获取投影对象
